...
@section('content')
    <div class="row vh-100">
        <div class="col-12 py-3 px-2 d-flex align-items-md-center justify-content-center">
            <div class="card w-lg-75 w-100">
                <div class="card-body">
                    <h2 class="card-title text-center text-uppercase">Student Database - Textile Institute Dinajpur</h2>
                    <p class="text-center text-warning">Fill the form with correct information. Each field of the form must be filled.</p>
                    <p class="text-center fw-bold text-danger">All the fields are <strong><em>required</em></strong> and will be validate from the server!!!</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="student-name-english-column" class="form-control" placeholder="Shakil Ahmed" name="student-name-english" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="number" id="birth-certificate-number" class="form-control" placeholder="20072722000000008" name="birth-certificate-number" minlength="13" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="birth-date" name="birth-date" class="form-control picker flatpickr-basic flatpickr-input active" placeholder="YYYY-MM-DD" readonly="readonly" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="number" id="student-mobile" class="form-control" placeholder="017xxxxxxxx" name="student-mobile" pattern="[0-9]{4}[0-9]{3}[0-9]{4}" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="father-name-bangla-column" class="form-control" placeholder="শাকিল আহমেদ" name="father-name-bangla" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="father-name-english-column" class="form-control" placeholder="Shakil Ahmed" name="father-name-english" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="mother-name-bangla-column" class="form-control" placeholder="শাকিলা আহমেদ" name="mother-name-bangla" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="mother-name-english-column" class="form-control" placeholder="Shakila Ahmed" name="mother-name-english" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="father-birth-date" name="father-birth-date" class="form-control picker flatpickr-basic flatpickr-input active" placeholder="YYYY-MM-DD" readonly="readonly" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="mother-birth-date" name="mother-birth-date" class="form-control picker flatpickr-basic flatpickr-input active" placeholder="YYYY-MM-DD" readonly="readonly" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="father-mobile" class="form-control" placeholder="017xxxxxxxx" name="father-mobile" pattern="[0-9]{4}[0-9]{3}[0-9]{4}" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="mother-mobile" class="form-control" placeholder="017xxxxxxxx" name="mother-mobile" pattern="[0-9]{4}[0-9]{3}[0-9]{4}" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea name="pres-address" id="pres-address" class="form-control" rows="2" required></textarea>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea name="perm-address" id="perm-address" class="form-control" rows="2" required></textarea>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="number" name="pe-passing-year" id="pe-passing-year" class="form-control" placeholder="2015" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="pe-technology-trade" id="pe-technology-trade" class="form-control" placeholder="Computer Science" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="pe-att-rate" id="pe-att-rate" class="form-control disabled" value="75%" readonly="readonly" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="ce-institute-name" id="ce-institute-name" class="form-control" placeholder="Textile Institute Dinajpur" required>
                                    <div class="valid-feedback">Looks good!</div>
                                    <div class="invalid-feedback">Please enter institute name.</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="ce-group" name="ce-group" class="form-control" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="guardian-name-english" name="guardian-name-english" class="form-control" placeholder="Fazlay Rabbbi" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="guardian-birth-date" name="guardian-birth-date" class="form-control picker flatpickr-basic flatpickr-input active" placeholder="YYYY-MM-DD" readonly="readonly" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="number" id="guardian-mobile" class="form-control" placeholder="017xxxxxxxx" name="guardian-mobile" pattern="[0-9]{4}[0-9]{3}[0-9]{4}" required>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="demo-inline-spacing">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <div class="invalid-feedback">Please select who will borne your education cost.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="demo-inline-spacing">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <div class="invalid-feedback">Please select your freedom fighter quota availability.</div>
                                        </div>
                                        <div class="form-check form-check-inline">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="demo-inline-spacing">
                                        <div class="form-check form-check-inline">
                                            <input id="payment-mobile" class="form-check-input" type="radio" name="payment-method" value="mobile-banking" checked="" required>
                            ...
                            <div id="payment-mobile-info" class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <select name="mobile-bank-provider" id="mobile-bank-provider" class="form-select" required>
                                            <option selected disabled value="">Select Mobile Banking Service Provider</option>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="number" id="mobile-bank-account" class="form-control" name="mobile-bank-account" placeholder="017xxxxxxxx" required>
                                        <div class="valid-feedback">Looks good!</div>
                            ...
                            <div id="payment-bank-info" class="row" style="display: none">
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <select name="bank-name" id="bank-name" class="form-select" required>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="bank-branch" class="form-control" name="bank-branch" placeholder="Dinajpur" required>
                                        <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="bank-routing" class="form-control" name="bank-routing" placeholder="070280676" required>
                                        <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <select name="bank-acc-type" id="bank-acc-type" class="form-select" required>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="bank-acc-name" class="form-control" name="bank-acc-name" placeholder="Shakil Ahmed" required>
                                        <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="number" id="bank-acc-number" class="form-control" name="bank-acc-number" placeholder="200154655xxxxx" required>
                                        <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="file" id="formal-photo" class="form-control" name="formal-photo" accept="image/png, image/jpeg, .jpg" required>
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="file" id="signature" class="form-control" name="signature" accept="image/png, image/jpeg, .jpg" required>
                                    <div class="valid-feedback">Looks good!</div>
