         ...
         <div class="table-responsive">
            <table class="table-bordered table">
               ...
               <tr>
                  ...
                  <td
                     colspan="2" class="bn">{{ !str_contains($previousUrl, 'StudentNameBengali') ?
                     $applicant->student_name_bangla : '' }}</td>
                  <td rowspan="5">
               ...
               <tr>
                  ...
                  <td colspan="2">{{ !str_contains($previousUrl, 'StudentName') ? $applicant->student_name_english :
                  '' }}</td>
               ...
               <tr>
                  ...
                  <td
                     colspan="2">{{ !str_contains($previousUrl, 'BirthCertificateNumber') ? $applicant->birth_certificate_number :
                     '' }}</td>
               ...
               <tr>
                  ...
                  <td>{{ !str_contains($previousUrl, 'PermanentCityCorp/Municipality') ? $applicant->perm_city_corp : '' }} </td>
                  <th class="w-25">Municipality/Union/City Corp.:</th>
                  <td>{{ !str_contains($previousUrl, 'PresentCityCorp/Municipality') ? $applicant->pres_city_corp : '' }} </td>
               </tr>
               <tr>
