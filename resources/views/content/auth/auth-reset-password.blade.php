               ...
               <form class="auth-reset-password-form mt-2" action="{{ route('password.update') }}" method="POST">
                  ...
                  <div class="mb-1">
                     ...
                     <div class="input-group input-group-merge form-password-toggle">
                        <input type="text" class="form-control disabled" id="email-new" name="email" value="{{ request()->email }}"
                           aria-describedby="email-new" tabindex="1" readonly="readonly" />
                     </div>
                  </div>
                  <div class="mb-1">
                     <div class="d-flex justify-content-between">
                     ...
                     <div class="input-group input-group-merge form-password-toggle">
                        <input type="password" class="form-control form-control-merge" id="reset-password-new" name="password"
                  ...
                  <div class="mb-1">
                     ...
                     <div class="input-group input-group-merge form-password-toggle">
                        <input type="password" class="form-control form-control-merge" id="reset-password-confirm" name="password_confirmation"
