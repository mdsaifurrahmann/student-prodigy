...
$(function () {
   ...
   if (dt_basic_table.length) {
      dt_basic_table.DataTable({
         ajax: window.location.origin + "/authenticated/dash/api/user-list",
         columns: [
            { data: "responsive_id" },
            { data: "id" },
            ...
            // },
            {
               ...
               render: function (data, type, full, meta) {
                  return (
                     ...
                     // '<a href="#" class=" my-1 d-block btn btn-primary waves-effect waves-float waves-light">' +
                     // feather.icons["file-text"].toSvg({
                     //    class: "font-small-4 me-50",
                     // }) +
                     // "View Detail</a>" +

                     '<button class="my-1 d-block btn btn-danger waves-effect waves-float waves-light" onClick="swal(' + full["id"] + ')">' +
