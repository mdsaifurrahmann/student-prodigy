...
class UpdateformHandlerRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'mobile_bank_account_holder' => 'exclude_if:payment_method,==,BANKING|required',
            'mobile_bank_holder_nid'     => 'exclude_if:payment_method,==,BANKING|required',
            'bank_name'                => 'exclude_if:payment_method,==,MOBILE BANKING|required',
            'bank_branch'              => 'exclude_if:payment_method,==,MOBILE BANKING|required',
            'bank_routing'             => 'exclude_if:payment_method,==,MOBILE BANKING|required',
            'bank_acc_type'            => 'exclude_if:payment_method,==,MOBILE BANKING|required',
            'bank_acc_name'            => 'exclude_if:payment_method,==,MOBILE BANKING|required',
            'bank_acc_number'          => 'exclude_if:payment_method,==,MOBILE BANKING|required',
            'formal_image'             => 'mimes:jpg,png,jpeg|max:512',
            'signature_image'          => 'mimes:jpeg,png,jpg|max:512',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'ce_session.required' => 'Please enter your session year',
            ...
            'mobile_bank_account_holder.required' => 'Please enter your mobile banking account holder name',
            'mobile_bank_holder_nid.required'     => 'Please enter your mobile banking account holder\'s NID number',
